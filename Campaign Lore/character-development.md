# Character Development — The Wake of the World-Eater

*Per-unit record of Path abilities and scar history. The Battle Bible holds current state; this file holds the full journey.*
*Updated by the Aftermath Gem after each battle.*

---

## How to Read This File

**Path Abilities** — every ability a unit has ever earned, in order, with the battle it was earned and the tier it belongs to.
**Scar History** — every scar a unit has ever received, when it was earned, and whether it was later cleared by healing.

Scars in this campaign are **not permanent** — they clear if wounds are healed below the threshold. A scar marked `CLEARED` was real, it affected play, and it's gone now.
...
| ----- | ----- | ----- | ----- | ----- |
| Setup | **Tough Git** | Aspiring | This cranky and calloused git is known to be a right tough 'un. | Add 1 to this unit's Health characteristic. |
| B5 | **Titan's Whisper** | Elite | The noise in Bossy's skull has stopped being suffering and started being useful. | Start of Hero Phase: Roll D6. On a 1, suffer 1 Mortal Wound. On a 2+, gain 1 Command Point. |
...
| Battle | Ability | Tier | Narrative | Effect |
| ----- | ----- | ----- | ----- | ----- |
| B1–3 (retro) | **Among the Mob** | Aspiring | He's never led from the front — he leads from the middle, where the mob's warmth keeps the fear manageable. | While this unit is within 3" of 2 or more friendly units, this unit has a Ward (6+). |
...
| Battle | Ability | Tier | Narrative | Effect |
| ----- | ----- | ----- | ----- | ----- |
| B6 | **Shiny Hat Trick** | Aspiring | The squig doesn't dodge — it just can't be predicted, and neither can the grot riding it. | Subtract 1 from Hit rolls for attacks that target this unit. |

#### Scar History
| Battle | Scar | Severity | Effect | Status |
| ----- | ----- | ----- | ----- | ----- |
| B6 | **Cracked Ribs** | Serious | Could not issue Commands. | ✅ CLEARED — healed below threshold after B6 |
...
| Battle | Ability | Tier | Narrative | Effect |
| ----- | ----- | ----- | ----- | ----- |
| B3 | **Pack Hunters** | Aspiring | The Bounderz have learned to herd their squigs in sync with the feral droves. | *Path of the Vanguard.* If this unit finishes a Charge move within 3" of a friendly Squig Herd unit, add +1 to Wound rolls for attacks made with this unit's Fang-filled Gobs for the rest of the turn. |
...
| Battle | Ability | Tier | Narrative | Effect |
| ----- | ----- | ----- | ----- | ----- |
| B5 | **Coward's Cunning** | Aspiring | They've discovered that fear, properly directed, is the fastest thing on the battlefield. | This unit can reroll Run rolls. |
...
| Battle | Ability | Tier | Narrative | Effect |
| ----- | ----- | ----- | ----- | ----- |
| B3 | **Stone-Hardened** | Aspiring | The chaotic energies of the Mutalith calcified its hide, which cracks and regrows like living rock. | *Path of the Monster.* Regeneration — in your Hero Phase, you can Heal up to D3 wounds allocated to this unit. |
...
| Battle | Ability | Tier | Narrative | Effect |
| ----- | ----- | ----- | ----- | ----- |
| B1–3 (retro) | **Petrified Hide** | Aspiring | Each battle leaves the hide a little harder — wounds seal over and the rock does not give the same ground twice. | Subtract 1 from the Rend characteristic of attacks that target this unit (to a minimum of 0). |
...
| Battle | Ability | Tier | Narrative | Effect |
| ----- | ----- | ----- | ----- | ----- |
| B2 | **Path of the Attacker** | Aspiring | Whirling through enough battles has given them an instinct for the precise moment the chain can bite. | Add 1 to Hit rolls for attacks made by this unit this phase. |
...
| Battle | Scar | Severity | Effect | Status |
| ----- | ----- | ----- | ----- | ----- |
| B5 | **Fear of Silence** | Serious | Subtract 1 from Casting and Unbinding rolls. | 🔴 ACTIVE |
...
| Battle | Ability | Tier | Narrative | Effect |
| ----- | ----- | ----- | ----- | ----- |
| B3 | **Iron Discipline** | Aspiring | They fight back-to-back, refusing to break formation even when charged. | *Path of the Soldier.* Shield Wall — Add +1 to Save rolls for attacks made by units that finished a Charge move in the same turn. |
...
| Battle | Ability | Tier | Narrative | Effect |
| ----- | ----- | ----- | ----- | ----- |
| B5 | **The Numbness** | Aspiring | Wound enough times in enough places, you stop feeling it — Gunnar simply kept moving. | This unit has a Ward (6+). |

#### Scar History
| Battle | Scar | Severity | Effect | Status |
| ----- | ----- | ----- | ----- | ----- |
| *TBD* | *Serious scar* | Serious | *(Effect TBD — confirm with StD player)* | Retired with scar active |
...
| Battle | Ability | Tier | Narrative | Effect |
| ----- | ----- | ----- | ----- | ----- |
| B5 | **The Ghost-Daughter** | Aspiring | Her name became a rumour on the enemy side; they started aiming at where she'd been, not where she was. | Subtract 1 from Hit rolls for Shooting attacks targeting this unit. |
...
| Battle | Scar | Severity | Effect | Status |
| ----- | ----- | ----- | ----- | ----- |
| B5 | **The Hollow Stare** | Severe | Could not receive Commands (Rally, All-out Attack, Redeploy). | Retired with scar active |
